    ...
    <div className="space-y-4">
      ...
      <div className="rounded-xl border border-gray-100 p-4 bg-gray-50">
        ...
        <div className="flex items-center gap-2 mb-1">
          {/* naverPlaceUrl 등록 = 사용자가 직접 연동 = 플레이스 존재 확인. 스캔 감지 여부와 독립 판단 */}
          {(naverResult?.is_smart_place || !!naverPlaceUrl)
            ? <CheckCircle2 className="w-4 h-4 text-green-600 shrink-0" />
            : <AlertOctagon className="w-4 h-4 text-gray-400 shrink-0" />
          }
          <span className="text-sm text-gray-700">
            {(naverResult?.is_smart_place || !!naverPlaceUrl)
              ? "네이버 지도 플레이스 등록됨"
              : "네이버 플레이스 URL 미연동 — 설정에서 등록하세요"}
          </span>
        </div>
        <div className="flex items-center gap-2">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 flex-wrap mb-1">
              <span className={`text-sm md:text-base font-semibold ${aiBriefingApplicable ? "text-gray-800" : "text-indigo-900"}`}>
                {aiBriefingApplicable ? "⑥ AI 브리핑 인용" : "⑥ 네이버 AI탭 (Beta · 2026-04-27 출시)"}
              </span>
            ...
            <p className={`text-sm ${aiBriefingApplicable ? "text-gray-500" : "text-indigo-700"}`}>
              {aiBriefingApplicable
                ...
                : "네이버 AI탭은 현재 음식점·카페 등 장소형 업종이 주요 노출 사례이며, 2026-06 전체 확대 예정입니다 (2026-04-27 베타)"}
            </p>
          </div>
      ...
      {briefingEligibility === "inactive" ? (
        <div className="rounded-xl border border-indigo-100 bg-indigo-50 p-4">
          <div className="flex items-start justify-between gap-3 mb-2">
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 flex-wrap mb-1">
                <span className="text-sm md:text-base font-semibold text-indigo-900">4. 네이버 AI탭 (Beta · 2026-04-27 출시)</span>
                <span className="text-sm text-indigo-700 bg-indigo-100 border border-indigo-200 px-2 py-0.5 rounded-full font-medium">
                  업종 공식 제한 없음
                </span>
              </div>
              <p className="text-sm text-indigo-700 leading-relaxed">
                네이버 AI탭은 현재 음식점·카페 등 장소형 업종이 주요 노출 사례입니다. 스마트플레이스 데이터 기반 시뮬레이션 (2026-06 전체 사용자 확대 예정, 네이버 공식)
              </p>
            </div>
          </div>
          <div className="flex items-start gap-2 bg-white rounded-lg p-3 border border-indigo-100">
      ...
      <div className="p-4 md:p-6 space-y-6">
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            ...
            {effectiveGroup === "INACTIVE" ? (
              <span className="text-sm px-3 py-1 rounded-full font-semibold border bg-indigo-50 text-indigo-600 border-indigo-100">
                AI탭 준비 가능
              </span>
            ) : (
          ...
          {effectiveGroup === "INACTIVE" && (
            <div className="mb-3 rounded-lg border border-indigo-100 bg-indigo-50 p-3 flex items-start gap-2">
              ...
              <p className="text-sm text-indigo-800 leading-relaxed">
                ...
                대신 <strong>네이버 AI탭</strong>(업종 공식 제한 없음, 2026-04-27 베타)을 통해 노출 가능합니다.{" "}
