...
const FAQS = [
  ...
  },
  {
    ...
    a: "네이버 AI탭(2026년 4월 베타 출시)은 AI 브리핑과 달리 업종 공식 제한은 없으나, 현재 실측 기준으로 음식점·카페 등 장소형 업종이 주요 노출 사례입니다. 네이버플러스 구독자 대상으로 먼저 운영 중이며 2026-06 전체 사용자 확대 예정입니다. 스마트플레이스 소개글·사진·소식을 충실히 관리할수록 확대 시 노출 가능성이 높아집니다.",
  },
  {
