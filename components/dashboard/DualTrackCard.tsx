  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 md:p-5 space-y-3 md:space-y-4">
      ...
      <ScoreBar
        ...
        immediateAction="구글 비즈니스 프로필 등록 (무료) — Gemini 개선 가장 빠른 경로"
        channelType="global"
      />
      {/* Track 2 면책 문구 — AI 데이터 유무와 무관하게 항상 표시 */}
      <p className="text-xs text-gray-400 -mt-1 leading-relaxed px-1">
        ChatGPT 스캐너는 학습 데이터(컷오프 2024.06) 기반 — 한국 소상공인 포함률이 낮아 낮은 점수가 일반적, 개선 반영 수개월~1년. Gemini는 구글 비즈니스 프로필 등록으로 실사용 앱에서 2~4주 내 개선 시작 가능.
      </p>
      ...
      {hasAiData && (
        <div className="bg-blue-50 border border-blue-100 rounded-xl p-3 md:p-4">
          ...
          <p className="text-sm text-gray-400 mt-2.5 leading-relaxed">
            ChatGPT 측정은 학습 데이터(컷오프 2024.06) 기반이며 실시간 웹 검색 결과와 다릅니다. 실사용 Gemini 앱은 Google Search 실시간 연동으로 현재 웹 콘텐츠를 반영하며, 구글 비즈니스 프로필 개선 후 2~4주 내 반영이 시작됩니다.
          </p>
        </div>
      )}
