  ...
  return (
    <div className="space-y-4">
                ...
                return (
                  <Fragment key={key}>
                    ...
                    <div className="col-span-2 flex items-start gap-2 rounded-xl px-3 py-3 border bg-indigo-50 border-indigo-200">
                      ...
                      <div className="flex-1 min-w-0">
                        <span className="text-sm font-semibold text-indigo-700">네이버 AI탭 (Beta · 2026년 6월 전체 출시 예정)</span>
      ...
      <p className="text-sm text-gray-600 mt-3 leading-relaxed">
        ChatGPT 측정은 학습 데이터(컷오프 2024.06) 기반이며 실시간 웹 검색 결과와 다릅니다. 한국 지역 소상공인은 포함률이 낮아 낮은 점수가 일반적입니다. 실사용 Gemini 앱은 Google Search 실시간 연동으로 현재 웹 콘텐츠를 반영하며, 구글 비즈니스 프로필 개선 후 2~4주 내 반영이 시작됩니다.
      </p>
    </div>
  );
}
