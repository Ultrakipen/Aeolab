  ...
  return (
    <div className={`rounded-xl border p-4 ${style}`}>
      <div className="flex items-center justify-between mb-2">
        ...
        <span className={`text-sm font-medium px-2 py-0.5 rounded-full ${isNotMentioned ? "bg-gray-100 text-gray-500" : "bg-white/60"}`}>
      ...
      {isNotMentioned && (
        <p className="text-sm text-gray-500 mt-1">
          ...
          <span className="text-gray-400 text-xs">글로벌 AI는 온라인 콘텐츠가 충분히 쌓인 후 인식하며, 처음에는 미언급이 일반적입니다.</span>
        </p>
      )}
