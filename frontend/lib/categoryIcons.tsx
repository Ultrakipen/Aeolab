...
export const CATEGORY_ICON_MAP: Record<string, CategoryIconConfig> = {
  ...
  food:          { Icon: Utensils,      bg: 'bg-orange-100', text: 'text-orange-700', border: 'border-orange-200' },
  health:        { Icon: HeartPulse,    bg: 'bg-red-100',    text: 'text-red-700',    border: 'border-red-200'    },
  ...
  shopping:      { Icon: ShoppingBag,   bg: 'bg-emerald-100',text: 'text-emerald-700',border: 'border-emerald-200'},
  living:        { Icon: Wrench,        bg: 'bg-amber-100',  text: 'text-amber-700',  border: 'border-amber-200'  },
  ...
  video:         { Icon: Video,         bg: 'bg-red-100',    text: 'text-red-700',    border: 'border-red-200'    },
  ...
  restaurant: { Icon: UtensilsCrossed, bg: 'bg-orange-100', text: 'text-orange-700', border: 'border-orange-200' },
  ...
  nail:       { Icon: Sparkles,        bg: 'bg-rose-100',   text: 'text-rose-700',   border: 'border-rose-200'   },
  ...
  fitness:    { Icon: Dumbbell,        bg: 'bg-red-100',    text: 'text-red-700',    border: 'border-red-200'    },
  ...
  jjimjil:      { Icon: Flame,          bg: 'bg-orange-100', text: 'text-orange-700', border: 'border-orange-200' },
  ...
  semi_permanent:    { Icon: Pen,        bg: 'bg-rose-100',    text: 'text-rose-700',    border: 'border-rose-200'    },
  ...
  stationery:        { Icon: PenLine,    bg: 'bg-orange-100',  text: 'text-orange-700',  border: 'border-orange-200'  },
