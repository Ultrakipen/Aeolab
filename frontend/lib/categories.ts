...
export const FLAT_CATEGORY_GROUPS: { groupLabel: string; items: FlatCategory[] }[] = [
  {
    ...
    items: [
      ...
      { value: "cafe",       label: "카페",       group: "food",          groupLabel: "음식·음료",
        ...
        tags: ["수제 베이커리", "케이크 주문제작", "브런치 메뉴", "노트북 작업 가능", "테라스·야외석", "포장·테이크아웃 가능", "반려견 동반 가능", "데이트 분위기", "감성 인테리어", "주차 가능", "가성비 좋음", "단체 예약 가능", "심야 영업", "스터디 가능"] },
      ...
      { value: "bar",        label: "술집",        group: "food",          groupLabel: "음식·음료",
        ...
        tags: ["야장 있음", "혼술 가능", "단체 예약 가능", "회식 장소", "프라이빗룸", "데이트 분위기", "생맥주", "안주 다양", "심야 영업", "가성비 좋음", "주차 가능", "포차 분위기"] },
  ...
  },
  {
    ...
    items: [
      ...
      { value: "realestate", label: "부동산",        group: "professional", groupLabel: "전문직·서비스",
        tags: ["매매 전문", "전세 상담", "월세 상담", "주거용 전문", "상업용 전문", "분양 상담", "경매 상담", "무료 상담", "지역 전문가", "법인 거래"] },
      { value: "interior",   label: "인테리어",      group: "living",       groupLabel: "전문직·서비스",
        tags: ["리모델링 전문", "부분 인테리어", "3D 설계 제공", "무료 견적", "주거 인테리어", "상업 인테리어", "맞춤 제작", "친환경 소재", "시공 보증", "빠른 시공"] },
      { value: "auto",       label: "카센터·정비",  group: "living",       groupLabel: "전문직·서비스",
        tags: ["엔진오일 교환", "타이어 교체", "브레이크 정비", "에어컨 수리", "보험 수리 가능", "당일 처리", "무료 점검", "수입차 가능", "견인 서비스", "주차 가능"] },
