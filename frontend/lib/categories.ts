...
export const CATEGORY_GROUPS: CategoryGroup[] = [
  ...
  },
  {
    group: "전문직",
    options: [
      { value: "law",           label: "법률·변호사·법무사" },
      { value: "tax",           label: "세무사·회계사·노무사" },
  ...
  },
  {
    ...
    options: [
      ...
      { value: "furniture",     label: "가구·침구·인테리어 소품" },
  ...
  },
  {
    group: "문화·예술·여가",
    options: [
      { value: "music_live",    label: "라이브 클럽·공연장" },
      { value: "recording",     label: "녹음실·음악 프로덕션" },
      { value: "instrument",    label: "악기판매·악기레슨" },
      { value: "karaoke_pro",   label: "코인노래방·프리미엄 노래방" },
      { value: "workshop",      label: "공방·클래스·원데이 체험" },
      { value: "culture",       label: "공연·전시·갤러리" },
      { value: "kids",          label: "키즈카페·어린이 체험" },
