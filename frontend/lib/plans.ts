...
export const PLANS: PlanInfo[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "수동 스캔 하루 2회 — 스마트플레이스 수정 후 네이버 노출 변화를 빠르게 확인",
      "리뷰 답변 초안 월 50회",
  ...
  },
  {
    ...
    features: [
      "경쟁사가 FAQ·소식을 추가하거나 리뷰·사진이 크게 늘면 주 1회(매주 월요일) 자동 알림",
  ...
  },
  {
    ...
    valueTag: "이 지역 실제 사업자 수와 경쟁사 준비 상태를 미리 확인하세요",
    killerFeature: "국세청 실측 시장 규모·폐업율 + 경쟁사 스마트플레이스 준비도 진단",
    features: [
      "국세청 사업자등록 기반 이 지역 실제 시장 규모·밀도 분석",
      "경쟁사 스마트플레이스 준비도 실측 — 소개글·소식 누락 여부로 차별화 포인트 발굴",
