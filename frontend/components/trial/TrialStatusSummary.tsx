...
function getContextSentence(score: number, userGroup: string): {
  ...
  if (userGroup === "INACTIVE" || userGroup === "franchise") {
    return {
      ...
      sub: "ChatGPT·Gemini·Google AI 노출 최적화가 핵심입니다. 네이버 AI탭(업종 공식 제한 없음, 2026-04-28 베타)도 확인하세요.",
...
function getConclusion(params: {
  ...
  if (userGroup === "INACTIVE" || userGroup === "franchise") {
    return "ChatGPT·Gemini 최적화에 집중하세요. 네이버 AI탭(업종 공식 제한 없음, 2026-04-28 베타, 2026년 6월 정식 출시 예정)도 확인하세요.";
  }
  if (userGroup === "LIKELY") {
