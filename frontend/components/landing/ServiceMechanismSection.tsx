        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4">
            <GateCard
              ...
              detail="그 외 업종도 블로그·콘텐츠로 '정보형 AI 브리핑'에 노출 가능하며, ChatGPT·Gemini·Google AI + 네이버 AI탭(업종 제한 발표 없음, 2026-06-25 정식 출시) 노출 개선으로도 가치 전달"
              variant="blue"
            />
            <GateCard
              num="②"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                ...
                >
                  ...
                  <ul className="space-y-2 text-sm leading-relaxed" style={{ color: "#0F172A" }}>
                    ...
                    <li>• 네이버 '플레이스형' AI 브리핑 비대상 업종을 플레이스형 대상으로 전환하기</li>
                    <li>• AI탭 토글을 대신 켜기</li>
                    <li>• 네이버 정책 위반 우회</li>
                  </ul>
                </div>
