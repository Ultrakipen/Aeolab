        ...
        {data.pooled_questions.slice(0, 10).map((row, i) => (
          ...
          >
            ...
            <button
              ...
              className="shrink-0 text-sm font-semibold text-amber-700 bg-white border border-amber-300 hover:bg-amber-100 rounded-lg px-2.5 py-1.5 transition-colors"
            >
