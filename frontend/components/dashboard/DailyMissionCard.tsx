...
const DIMENSION_MESSAGES: Record<string, {
  ...
  keyword_gap_score: {
    reason: '경쟁 가게보다 업종 키워드가 부족해 검색에서 순위가 밀리고 있습니다',
    action: '소개글 Q&A에 빠진 키워드를 추가하면 네이버·AI 검색에서 내 가게가 더 잘 검색됩니다',
    link: '/guide',
    linkLabel: '없는 키워드 확인하기',
  },
  review_quality: {
    reason: '리뷰 수·키워드가 경쟁 상위 가게보다 부족해 검색 노출이 낮습니다',
    action: '리뷰 답변에 가게 특징 키워드를 한 줄 추가하면 네이버가 내 가게를 더 잘 파악합니다',
    link: '/guide',
    linkLabel: '리뷰 답변 초안 보기',
  },
  smart_place_completeness: {
    reason: '스마트플레이스 정보가 부족해 네이버가 내 가게를 제대로 소개하지 못합니다',
    action: '소개글 Q&A·소식을 채우면 네이버 검색에서 내 가게 정보가 더 잘 나타납니다',
    link: '/guide',
    linkLabel: '소개글 편집하러 가기',
  },
  naver_exposure_confirmed: {
    reason: '네이버 AI 검색에서 아직 내 가게가 검색 결과에 나타나지 않았습니다',
    action: '소개글에 Q&A 3가지를 추가하면 네이버가 내 가게를 검색 결과에 포함시킵니다',
    link: '/guide',
