      ...
      <main className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-6">
        <div className="w-full max-w-sm">
          <div className="bg-white rounded-xl p-6 md:p-8 shadow-sm text-center">
            ...
            <p className="text-base text-gray-600 mb-2">으로 인증 링크를 발송했습니다.</p>
            <p className="text-sm text-gray-600 mb-4 leading-relaxed">
              링크를 클릭하면 자동으로 로그인됩니다.<br />
              메일이 오지 않으면 스팸함을 확인해주세요.
            </p>
            {resendDone ? (
              <p className="text-sm text-green-700 font-medium mb-4">✓ 인증 메일을 다시 발송했습니다.</p>
            ) : (
              <button
        ...
        <form onSubmit={handleSignup} className="bg-white rounded-xl p-6 shadow-sm space-y-5">
          ...
          <div>
            <label htmlFor="signup-password" className="block text-base font-medium text-gray-700 mb-1.5">
              ...
              <span className="text-sm font-normal text-gray-600 ml-1">(8자 이상)</span>
            </label>
            <input
              id="signup-password"
              type="password"
          ...
          <div>
            ...
            <input
              ...
              className={`w-full border rounded-xl px-4 py-3.5 text-base focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder:text-gray-600 ${
            ...
            />
            {passwordConfirm && password !== passwordConfirm && (
              <p className="text-base text-red-700 mt-1.5">비밀번호가 일치하지 않습니다.</p>
            )}
          </div>
          ...
          <div className="border border-gray-100 rounded-xl p-4 space-y-3.5 bg-gray-50">
            ...
            <label className="flex items-center gap-3 cursor-pointer">
              ...
              <span className="text-base text-gray-700 leading-snug">
                <span className="text-gray-600 font-medium">[선택]</span>{" "}
