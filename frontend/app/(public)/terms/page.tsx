        ...
        <div className="prose prose-gray max-w-none space-y-8 text-sm md:text-base leading-relaxed text-gray-700">
          ...
          <section>
            ...
            <ol className="list-decimal pl-5 space-y-2">
              ...
              <li>대행 서비스(스마트플레이스 등록·최적화 등 실행 대행)</li>
          ...
          <section>
            ...
            <ol className="list-decimal pl-5 space-y-2">
              ...
              <li><strong>청약철회(구독 취소):</strong> 이용자는 구독 시작일로부터 7일 이내에 청약철회를 신청할 수 있습니다. 단, 서비스를 이용(스캔·가이드 생성 등)한 경우에는 전자상거래법 제17조에 따라 청약철회가 제한될 수 있습니다. 서비스 내 해지 신청은 즉시 처리되며, 이메일(<a href="mailto:contact@aeolab.co.kr" className="text-blue-600 hover:underline">contact@aeolab.co.kr</a>) 신청은 접수 후 영업일 기준 3일 이내에 처리됩니다.</li>
          ...
          <section>
            <h2 className="text-lg md:text-xl font-semibold text-gray-900 mb-3">제5조의2 (대행 서비스 이용 및 환불)</h2>
            <ol className="list-decimal pl-5 space-y-2">
              <li>대행 서비스는 구독과 별개로 1회성 결제로 이용하는 서비스이며, 요금은 다음과 같습니다.
                <ul className="list-disc pl-5 mt-2 space-y-1">
                  <li>스마트플레이스 등록 대행: 59,000원</li>
                  <li>AI 검색 최적화: 79,000원</li>
                  <li>종합 풀패키지: 119,000원 (개별 구매 시 138,000원)</li>
                </ul>
              </li>
              <li>결제는 토스페이먼츠를 통한 신용카드·간편결제 등 1회성 결제(정기결제 아님)로 이루어지며, 결제 완료 후 영업일 1~2일 이내 담당자가 연락드립니다.</li>
              <li><strong>자동 환불:</strong> 결제 완료 후 7일 이내에 의뢰 내용(작업에 필요한 정보·자료)을 제출하지 않은 경우, 회사는 결제 금액을 전액 자동 환불합니다.</li>
              <li>작업 착수 전 취소를 원하는 경우 고객센터 문의를 통해 환불을 요청할 수 있으며, 이 경우 전액 환불됩니다. 작업이 착수된 이후의 환불 여부는 진행 상황에 따라 회사와 협의하여 결정합니다.</li>
              <li>작업이 완료되어 납품물(완료 보고서 등)이 제공된 건은 환불 대상에서 제외됩니다. 단, 회사의 귀책사유로 서비스가 정상적으로 제공되지 못한 경우에는 그러하지 않습니다.</li>
              <li>대행 서비스 이용 과정에서 회사에 위임한 네이버 스마트플레이스 부운영자 권한 등은 작업 완료 후 자동으로 해제됩니다.</li>
            </ol>
          </section>
          ...
          <section>
            ...
            <ol className="list-decimal pl-5 space-y-2">
              ...
              <li>회사의 손해배상 한도는 최근 3개월간 이용자가 납부한 구독 요금(대행 서비스 이용자의 경우 해당 대행 서비스 결제 금액)을 초과하지 않습니다.</li>
