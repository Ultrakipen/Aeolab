      ...
      <article className="max-w-3xl mx-auto px-4 md:px-6 py-8 md:py-12">
          ...
          <div className="divide-y divide-gray-100">
            ...
            <div className="flex items-start gap-3 px-4 py-3.5">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-0.5 leading-relaxed">스마트플레이스 <strong>소개글 작성</strong> + <strong>소식 탭 최근 게시물</strong> — 두 항목이 네이버 채널 점수를 가장 크게 끌어올립니다. 광고비 없이 콘텐츠만으로 가능한 가장 확실한 개선입니다. <span className="text-gray-400">(내부 기준: 소식 25 + 소개글 20점)</span></p>
              </div>
            </div>
          </div>
        </div>
        ...
        <nav className="bg-gray-50 rounded-xl p-5 mb-10">
          ...
          <ol className="space-y-1.5 text-sm md:text-base text-blue-600">
            ...
            <li><a href="#ai-tab" className="hover:underline">네이버 AI탭 — 업종 공식 제한 없음, 베타 확대 중</a></li>
        ...
        <section id="step1" className="mb-12 scroll-mt-20">
          ...
          <div className="rounded-xl border border-blue-300 bg-blue-50 p-4 md:p-5">
            ...
            <p className="text-sm text-blue-700 mt-3 leading-relaxed break-keep">
        ...
        <section id="channel-speed" className="mb-12 scroll-mt-20">
          ...
          <div className="space-y-3 mb-5">
            ...
            <div className="rounded-xl border-2 border-blue-300 bg-blue-50 p-4">
              ...
              <p className="text-sm text-blue-700 mt-2 ml-9">실사용 Gemini 앱은 Google Search 그라운딩(실시간 색인) 기반 → 수주 내 반영 가능. 안정적 인용까지는 3~6개월.</p>
            </div>
            ...
            <div className="rounded-xl border-2 border-purple-300 bg-purple-50 p-4">
              ...
              <p className="text-sm text-purple-700 mt-2 ml-9">실시간 구글 색인 기반 → 색인 완료 후 2~4주 내 반영. 안정적 인용까지는 3~6개월.</p>
            </div>
            ...
            <div className="rounded-xl border-2 border-orange-300 bg-orange-50 p-4">
              ...
              <p className="text-sm text-orange-700 mt-2 ml-9">AEOlab 스캐너는 AI 학습 데이터 기반 측정 — 실시간 웹 반영까지 수개월~1년 소요. 네이버 블로그는 ChatGPT 점수 개선에 직접 효과 없음.</p>
            </div>
          </div>
        ...
        <section id="ai-tab" className="mb-12 scroll-mt-20">
          <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-3 break-keep">
            네이버 AI탭 — 업종 공식 제한 없음, 베타 확대 중
          </h2>
          <div className="rounded-xl border border-green-200 bg-green-50 p-4 md:p-5 mb-4">
            <p className="text-sm font-bold text-green-800 mb-1">현재 베타 확대 중</p>
            ...
            <div className="rounded-xl border border-blue-200 bg-blue-50/50 p-4">
              ...
              <div className="space-y-1.5 text-sm text-gray-700">
                ...
                <div className="flex gap-2">
                  ...
                  <span>2026-04-27 베타 출시 · 베타 확대 중 · 업종 공식 제한 없음</span>
                </div>
              </div>
            </div>
            <div className="rounded-xl border border-purple-200 bg-purple-50/50 p-4">
              <p className="text-sm font-bold text-purple-800 mb-2">노출 가능성을 높이는 방법</p>
        ...
        <section id="dia" className="mb-12 scroll-mt-20">
          ...
          <ul className="space-y-2 text-sm md:text-base text-gray-700 mb-4 leading-relaxed">
            ...
            <li>
              ...
              현재 네이버플러스 멤버십 우선 공개 중이며, 베타 확대 중입니다 (네이버 공식).
            </li>
            <li>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm md:text-base border-collapse min-w-[640px]">
              ...
              <tbody>
                ...
                <tr className="border-b border-gray-100"><td className="py-2.5 px-3">경쟁사 분석</td><td className="text-center py-2.5 text-gray-400">—</td><td className="text-center py-2.5">3개</td><td className="text-center py-2.5">5개</td><td className="text-center py-2.5">5개</td><td className="text-center py-2.5">무제한</td></tr>
                <tr className="border-b border-gray-100"><td className="py-2.5 px-3">창업 시장 분석</td><td className="text-center py-2.5 text-gray-400">—</td><td className="text-center py-2.5 text-gray-400">—</td><td className="text-center py-2.5">✅</td><td className="text-center py-2.5 text-gray-400">—</td><td className="text-center py-2.5">✅</td></tr>
...
function ContentCard({ num, title, detail }: ContentCardProps) {
  return (
    <div className="rounded-xl border bg-white p-4 md:p-5 flex gap-3">
      <span className="w-7 h-7 rounded-full bg-blue-100 text-blue-700 text-sm font-bold flex items-center justify-center shrink-0 mt-0.5">{num}</span>
