...
const GUIDE_DATA: Record<string, GuideData> = {
  restaurant: {
    label: "음식점",
    description:
      "음식점은 네이버 AI 브리핑 대상 업종입니다. 스마트플레이스 완성도, 리뷰 수, 소식 빈도가 노출 핵심 요소입니다.",
    checklist: [
  ...
  cafe: {
    label: "카페",
    description:
      "카페는 네이버 AI 브리핑 대상 업종입니다. 시그니처 음료 사진, 좌석 환경 정보, 소식 주기가 방문 유도의 핵심입니다.",
    checklist: [
      "스마트플레이스 소개글 200자 이상 작성",
  ...
  bakery: {
    label: "베이커리",
    description:
      "베이커리는 네이버 AI 브리핑 대상 업종입니다. 당일 생산 품목 소식, 시그니처 빵 사진, 영업시간 정확도가 핵심입니다.",
    checklist: [
  ...
  beauty: {
    label: "미용실·헤어",
    description:
      "미용실은 네이버 '플레이스형' AI 브리핑 확대 예정 업종입니다. 블로그·콘텐츠로 '정보형 AI 브리핑' 노출도 지금 가능합니다. 시술 전후 사진, 예약 연동, 가격 정보 투명화가 검색 전환 핵심입니다.",
    checklist: [
    ...
    top3: [
      ...
      {
        title: "예약 연동 설정",
        desc: "네이버 예약이 연동된 업소는 예약 전환 경로가 짧아 방문 결정으로 이어지기 유리합니다.",
      },
    ],
  },
  ...
  nail: {
    label: "네일샵",
    description:
      "네일샵은 네이버 '플레이스형' AI 브리핑 확대 예정 업종입니다. 블로그·콘텐츠로 '정보형 AI 브리핑' 노출도 지금 가능합니다. 디자인 포트폴리오 사진과 예약 연동이 키워드 커버리지 확대의 핵심입니다.",
    checklist: [
      "스마트플레이스 소개글 200자 이상 (주요 시술 포함)",
  ...
  fitness: {
    label: "헬스장·PT",
    description:
      "헬스장은 네이버 '플레이스형' AI 브리핑 확대 예정 업종입니다. 블로그·콘텐츠로 '정보형 AI 브리핑' 노출도 지금 가능합니다. 트레이너 소개, 시설 사진, 체험 프로그램 안내가 등록 전환의 핵심입니다.",
    checklist: [
  ...
  bar: {
    label: "주점·바",
    description:
      "주점·바는 네이버 AI 브리핑 대상 업종입니다. 주류 메뉴·안주·분위기 사진과 정확한 영업시간이 AI 브리핑 노출의 핵심입니다.",
    checklist: [
      "스마트플레이스 소개글 200자 이상 (대표 주류·안주 포함)",
      "대표 메뉴·안주 사진 5장 이상 업로드",
      "영업시간 정확히 입력 (라스트오더 포함)",
      "네이버 예약 또는 입장 안내 등록",
      "사진 10장 이상 업로드 (주류·안주·내부 분위기 포함)",
      "소식 2주 이내 최소 1건 작성 (신메뉴·이벤트 등)",
      "카카오맵 정보 동기화 확인",
      "키워드 3개 설정 (예: 혼술, 안주, 와인바)",
      "리뷰 답글 3개 이상 작성",
      "주차 정보 및 오시는 길 입력",
      "연령 제한·드레스코드 안내 (해당 시)",
    ],
    keywords: ["주점", "바", "혼술", "안주", "와인바", "칵테일"],
    top3: [
      {
        title: "영업시간·라스트오더 정확 입력",
        desc: "'늦게까지 하는 바', '라스트오더 몇 시' 등 심야 쿼리에서 AI 브리핑 인용 가능성이 높아집니다.",
      },
      {
        title: "분위기 사진 풍부하게",
        desc: "인테리어·주류 진열·테이블 세팅 사진이 많을수록 '분위기 좋은 술집' 쿼리 응답에 인용되기 유리합니다.",
      },
      {
        title: "소식으로 신메뉴·이벤트 알리기",
        desc: "기간 한정 메뉴나 이벤트를 소식으로 올리면 '오늘 가볼 만한 바' 쿼리에서 최신성 점수가 높아집니다.",
      },
    ],
  },
  ...
  accommodation: {
    label: "숙박",
    description:
      "숙박업은 네이버 AI 브리핑 대상 업종입니다. 객실 사진, 편의시설 정보, 주변 관광지 키워드 연결이 노출 핵심입니다.",
    checklist: [
  ...
  pet: {
    label: "반려동물샵",
    description:
      "반려동물샵은 네이버 '플레이스형' AI 브리핑 확대 예정 업종입니다. 블로그·콘텐츠로 '정보형 AI 브리핑' 노출도 지금 가능합니다. 서비스별 요금, 전후 사진, 자격증 정보가 신뢰도 핵심입니다.",
    checklist: [
  ...
  education: {
    ...
    checklist: [
      ...
      "구글 비즈니스 프로필 등록 (business.google.com) — Gemini 노출에 특히 중요",
