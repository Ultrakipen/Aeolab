...
const GUIDE_DATA: Record<string, GuideData> = {
  ...
  beauty: {
    label: "미용실·헤어",
    description:
      "미용실은 네이버 AI 브리핑 확대 예정 업종입니다. 시술 전후 사진, 예약 연동, 가격 정보 투명화가 검색 전환 핵심입니다.",
    checklist: [
  ...
  nail: {
    label: "네일샵",
    description:
      "네일샵은 네이버 AI 브리핑 확대 예정 업종입니다. 디자인 포트폴리오 사진과 예약 연동이 키워드 커버리지 확대의 핵심입니다.",
    checklist: [
      "스마트플레이스 소개글 200자 이상 (주요 시술 포함)",
  ...
  fitness: {
    label: "헬스장·PT",
    description:
      "헬스장은 네이버 AI 브리핑 확대 예정 업종입니다. 트레이너 소개, 시설 사진, 체험 프로그램 안내가 등록 전환의 핵심입니다.",
    checklist: [
