      ...
      {(hasNumericData || (briefingCategory === "active" && inBriefing !== null)) && (
        <div className="grid grid-cols-3 gap-2 mb-4 pb-4 border-b border-slate-100">
          <div className="text-center bg-slate-50 rounded-xl p-3">
            ...
            <div className="text-xs font-semibold text-slate-600 mt-1.5">ChatGPT 추천</div>
          ...
          <div className="text-center bg-slate-50 rounded-xl p-3">
            ...
            <div className="text-xs font-semibold text-slate-600 mt-1.5">Gemini 추천</div>
            <div className="text-xs text-slate-400">10회 질의</div>
          </div>
          {briefingCategory === "active" ? (
            <div className="text-center bg-slate-50 rounded-xl p-3">
              ...
              <div className="text-xs font-semibold text-slate-600 mt-1.5">AI브리핑</div>
            ...
            <div className="text-center bg-slate-50 rounded-xl p-3">
              <div className="text-xl text-slate-300 leading-none mt-1">—</div>
              <div className="text-xs font-semibold text-slate-400 mt-1.5">AI브리핑</div>
      ...
      {(group === "INACTIVE" || group === "franchise") && (
        <div className="rounded-xl border-2 border-amber-400 bg-amber-50 px-4 py-3">
          ...
          <p className="text-sm text-amber-800 leading-relaxed mb-2 break-keep">
            {group === "franchise"
              ? "네이버 본사 정책에 따라 프랜차이즈 가맹점은 AI 브리핑 노출이 제한됩니다. 단, 네이버 AI탭(업종 공식 제한 없음, 2026년 6월 전체 출시 예정)도 확인하세요."
              : "ChatGPT·Gemini·Google AI 노출 최적화에 집중합니다. 또한 네이버 AI탭(업종 공식 제한 없음, 2026년 6월 전체 출시 예정)도 확인하세요."}
          </p>
          <div className="flex flex-wrap gap-2">
            {[
              { label: "네이버 AI탭", desc: "업종 공식 제한 없음 · 2026년 6월 전체 출시 예정" },
      ...
      {group === "LIKELY" && (
        <div className="rounded-xl border border-amber-200 bg-amber-50 px-4 py-3">
          <p className="text-sm font-semibold text-amber-900 mb-1">
            네이버 AI탭 — 2026년 6월 전체 출시 예정
          </p>
          <p className="text-sm text-amber-800 leading-relaxed">
            네이버 AI탭은 2026-04-27 베타 출시, 2026년 6월 전체 사용자 정식 출시 예정입니다 (업종 공식 제한 없음).
          ...
          !isLikely ? (
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-xl px-4 py-3">
              ...
              <p className="text-sm text-amber-700 leading-relaxed">
                ...
                AI탭(2026년 6월 전체 출시 예정)은 지금도 가능합니다. 정식 스캔에서 노출 여부를 모니터링합니다.
              </p>
            </div>
          )
        ) : (
