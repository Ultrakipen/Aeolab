...
const AI_FAQS = [
  {
    ...
    a: "네이버 AI 브리핑 네이버 플레이스 노출 대상 업종은 음식점·카페·베이커리·주점·숙박입니다. 미용·네일·피트니스·요가·반려동물 업종은 AI 브리핑 LIKELY(확대 검토 중) 상태로, 현재 AI 브리핑 노출 여부가 불확실합니다. 단, 네이버 AI탭은 업종 제한 없이 모든 사업장이 노출 대상입니다. 프랜차이즈 사업장은 업종에 상관없이 네이버 정책상 '플레이스형' AI 브리핑 대상에서 제외됩니다. 단, '정보형 AI 브리핑'과 AI탭·ChatGPT·Gemini에서는 노출 가능합니다. 그 외 업종(학원·병원·법무사·부동산 등)은 '플레이스형' AI 브리핑 대상이 아니지만, 블로그·콘텐츠가 잘 갖춰지면 '정보형 AI 브리핑'에 노출될 수 있습니다. ChatGPT·Gemini·Google AI 노출 최적화도 효과적이며, AEOlab은 이 채널도 함께 측정합니다. 정확한 업종 여부는 무료 체험에서 바로 확인할 수 있습니다.",
  },
  {
