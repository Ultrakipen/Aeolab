...
const AI_FAQS = [
  ...
  },
  {
    ...
    a: "AI 브리핑은 검색 결과 상단에 자동으로 뜨는 추천 박스로, 음식점·카페·숙박 등 일부 업종만 해당합니다. AI탭은 검색창 상단 'AI' 탭을 클릭하면 나오는 화면으로, 업종 제한 없이 모든 사업장이 노출될 수 있습니다. (2026년 4월 베타 출시, 6월 전체 사용자 확대 예정)",
  },
  {
  ...
  },
  {
    ...
    a: "네이버 AI탭(2026년 4월 베타 출시, 6월 전체 사용자 확대 예정)은 모든 업종이 노출 대상입니다. 최적화 핵심 5가지: ① 소개글 — 업종·특징·서비스를 자연어로 구체적으로 작성, ② 사진 — 업종별 필수 카테고리(음식·공간·메뉴판 등) 최신 사진 등록, ③ 예약·주문 — 네이버 예약/스마트주문 연동, ④ 리뷰 답변 — 최근 리뷰에 키워드 포함 답변, ⑤ 블로그 UGC — 실제 방문자 블로그 리뷰 축적. AI탭은 사용자 질문에 맞는 정보를 인용하므로, 소개글에 자주 받는 질문(주차 가능 여부·예약 방법 등)을 미리 Q&A 형식으로 넣으면 인용 가능성이 높아집니다.",
  },
  {
