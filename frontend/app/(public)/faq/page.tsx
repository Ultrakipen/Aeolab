...
const AI_FAQS = [
  ...
  },
  {
    ...
    a: "채널마다 반영 기간이 다릅니다. 네이버 AI 브리핑·AI탭: 소개글·소식 업데이트 후 2~4주. Gemini: 구글 비즈니스 프로필 업데이트 후 수 주~수개월 (Google 검색 실시간 연동으로 시작은 빠르나 안정 인용까지 수개월 소요). ChatGPT: AEOlab 스캐너 점수는 ChatGPT 학습 데이터 기반이므로 모델 재학습 주기(수개월~1년)에 의존합니다. 실사용자 ChatGPT 웹검색(Bing 기반)은 구글 비즈니스 프로필 등록 후 1~4주 내 반영됩니다.",
  },
  {
  ...
  },
  {
    ...
    a: "Google의 Gemini는 Google 비즈니스 프로필(구 구글 마이비즈니스)과 Google 지도 데이터, 그리고 웹 전반의 콘텐츠를 기반으로 답변합니다. 구글 비즈니스 프로필에 등록된 업종·설명·리뷰·사진·영업 시간이 Gemini 답변에 직접 반영됩니다. 네이버 스마트플레이스는 Gemini 답변에 거의 영향을 주지 않습니다. 구글 비즈니스 프로필 업데이트 후 Gemini 반영까지는 수 주~수개월이 소요됩니다. AEOlab은 Gemini 스캐너로 50~100회 샘플 쿼리를 실행해 실제 인용 빈도를 측정합니다.",
  },
  {
