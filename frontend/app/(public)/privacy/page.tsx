      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-gray max-w-none space-y-8 text-sm md:text-base leading-relaxed text-gray-700">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <ul className="list-disc pl-5 space-y-1">
                  ...
                  <li>쿠키 및 유사 기술 (Google Analytics 4를 통한 방문·이용 통계 분석 목적). 쿠키 저장을 거부하려면 웹 브라우저 설정에서 쿠키 저장을 거부할 수 있으며, 이 경우 일부 서비스 이용에 어려움이 있을 수 있습니다.</li>
                </ul>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              회원 탈퇴 즉시 모든 개인정보 및 서비스 데이터가 삭제됩니다.
              단, 법령에 따른 의무 보존 기간이 있는 결제 정보(전자상거래법 5년)는 해당 기간 동안 분리 보관 후 파기됩니다.
            </p>
          </section>
