...
const GROUP_CONTENT = {
  ...
  LIKELY: {
    ...
    badgeText: "AI탭 대상",
    changes: [
      "네이버 AI탭(정식 출시) 노출 반영이 새로 추가됩니다 — 2026-04-27 베타 출시(네이버플러스 우선) → 2026-06-25 전체 사용자 정식 출시 기준.",
  ...
  franchise: {
    ...
    badgeText: "프랜차이즈 맞춤",
    changes: [
      "네이버 '플레이스형' AI 브리핑 항목이 제외됩니다(네이버 공식 정책에 따라 가맹점은 '플레이스형' AI 브리핑 대상이 아닙니다).",
