...
const AI_FAQS = [
  ...
  },
  {
    ...
    a: "네이버 AI탭(2026년 4월 베타 출시, 전체 확대 예정)은 모든 업종이 노출 대상입니다. 최적화 핵심 5가지: ① 소개글 — 업종·특징·서비스를 자연어로 구체적으로 작성, ② 사진 — 업종별 필수 카테고리(음식·공간·메뉴판 등) 최신 사진 등록, ③ 예약·주문 — 네이버 예약/스마트주문 연동, ④ 리뷰 답변 — 최근 리뷰에 키워드 포함 답변, ⑤ 블로그 UGC — 실제 방문자 블로그 리뷰 축적. AI탭은 사용자 질문에 맞는 정보를 인용하므로, 소개글에 자주 받는 질문(주차 가능 여부·예약 방법 등)을 미리 Q&A 형식으로 넣으면 인용 가능성이 높아집니다.",
  },
  {
...
const SERVICE_FAQS = [
  ...
  {
    q: "무료 체험과 유료 구독의 차이는?",
    a: "무료 체험은 업종·지역을 입력하면 경쟁사 현황과 기본 점수를 한 번 확인할 수 있습니다. 유료 구독(Basic 9,900원/월)은 내 사업장을 등록하고, AI 4종 자동 스캔(네이버·ChatGPT·Gemini·Google AI Overview(Serper.dev 연동으로 정상 측정 중)) + 경쟁사 비교, 60일 트렌드, 월별 개선 가이드를 이용할 수 있습니다. 첫 달은 4,950원으로 시작할 수 있습니다.",
  },
  {
