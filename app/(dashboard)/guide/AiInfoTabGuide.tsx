          ...
          <>
            ...
            <p className="text-sm md:text-base text-gray-700 leading-relaxed break-keep">
              {business.is_franchise
                ? "AI탭(2026-04-27 베타 출시, 2026년 6월 전체 출시 예정, 음식점·카페 등 플레이스 기반 결과 주로 노출)·ChatGPT·Gemini 노출을 측정하고 개선합니다. 네이버 일반 검색 노출도 함께 관리합니다."
                : isInactive
                ? "네이버 AI탭(2026-04-27 베타 출시, 2026년 6월 전체 출시 예정, 현재 음식점·카페 등 장소형 위주)을 통한 노출을 준비할 수 있습니다. 아래 단계로 준비하세요. 일반 검색 노출과 병행 가능합니다."
                : isLikely
        ...
        {isInactive || business?.is_franchise ? (
          <>
            <StepSkipped
              ...
              reason={
                business?.is_franchise
                  ? "AI탭·ChatGPT·Gemini 노출에 집중하세요. 아래 AI탭 준비 가이드를 확인하세요."
                  : "이 업종은 AI탭(2026-04-27 베타, 2026년 6월 전체 출시 예정, 음식점·카페 등 플레이스 기반 결과 주로 노출)·ChatGPT·Gemini 채널에 집중하세요."
              }
            />
            ...
            <div className="rounded-xl border border-indigo-200 bg-indigo-50 p-4 md:p-5">
              <p className="text-sm md:text-base font-semibold text-indigo-800 mb-2">
                네이버 AI탭 준비 — 지금 바로 시작하세요
              </p>
              <p className="text-sm text-indigo-700 mb-3 leading-relaxed">
                네이버 AI탭(2026-04-27 베타 출시, 2026년 6월 전체 출시 예정)은 플레이스·쇼핑 에이전트 통합 검색으로 업종 공식 제한이 없습니다.
                현재 음식점·카페 등 장소형 업종 위주로 노출 확인. 아래 항목을 충실히 갖출수록 노출 가능성이 높아집니다.
              </p>
              ...
              <p className="mt-3 text-sm text-indigo-600">
                * AI탭은 2026년 6월 전체 출시 예정(현재 베타)입니다. AI탭 스캐너 오픈 후 실측 측정이 추가됩니다. 노출 기준은 네이버 알고리즘 기준이며 측정 시점·기기에 따라 달라질 수 있습니다.
              </p>
            </div>
          </>
        ) : (
          ...
          <div className="rounded-xl border border-indigo-200 bg-indigo-50 p-4 md:p-6 space-y-4">
            <div>
              ...
              <p className="text-sm text-indigo-700 leading-relaxed">
                네이버 AI탭(2026-04-27 베타, 2026년 6월 전체 출시 예정)은 플레이스·쇼핑 에이전트 통합 검색으로 업종 공식 제한이 없습니다.
                현재 음식점·카페 등 장소형 업종이 주요 노출 사례입니다. 아래 3단계로 노출 가능성을 높이세요.
              </p>
            </div>
