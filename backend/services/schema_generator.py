...
CATEGORY_TIPS: dict[str, dict[str, str]] = {
    ...
    "accommodation": {
        "smartplace_tip": "객실 종류별 사진과 기준 인원을 모두 등록하고, '체크인/체크아웃 시간', '주차 가능 여부'를 소개글에 명시하세요.",
        "blog_tip": "숙소 주변 여행 코스·맛집을 소개하는 포스트가 AI 브리핑 인용률이 높습니다. '~ 근처 숙소 추천' 등 지역 연계 키워드를 활용하세요.",
        "no_website_guide": "네이버 예약 연동과 구글 비즈니스 프로필을 완성하면 홈페이지 없이도 Google AI Overview·네이버 AI탭 노출이 가능합니다.",
    },
    "pharmacy": {
        "smartplace_tip": "처방전 조제 가능 여부와 '공휴일 운영', '야간 운영' 시간을 소개글에 정확히 명시하세요.",
        "blog_tip": "계절별 건강 정보(감기·알레르기 등) 포스트가 AI 검색 인용에 효과적입니다. 의약품 효능을 과장하는 표현은 약사법 위반 소지가 있으니 피하세요.",
        "no_website_guide": "구글 비즈니스 프로필에 운영시간·처방전 접수 여부를 등록하면 '지금 여는 약국' 같은 실시간 조건 검색에서 노출됩니다.",
    },
    "kids": {
        "smartplace_tip": "놀이시설 종류와 연령대별 이용 가능 여부, 보호자 동반 규정을 소개글에 명시하세요. 안전 관리 사진을 등록하면 신뢰도가 높아집니다.",
        "blog_tip": "'아이와 가볼만한 곳', '비 오는 날 실내 놀이' 등 상황별 키워드를 포함한 포스트가 학부모 검색에서 AI 인용률이 높습니다.",
        "no_website_guide": "인스타그램과 네이버 플레이스에 놀이 공간·프로그램 사진을 등록하면 홈페이지 없이도 학부모 대상 AI 검색 노출이 가능합니다.",
    },
    "service": {
        "smartplace_tip": "출장 가능 지역과 견적 산정 방식(방문 견적·전화 견적)을 소개글에 명시하고, 작업 전후 사진을 등록하세요.",
        "blog_tip": "시공·수리 전후 비교 사진 포스트가 신뢰도와 AI 검색 인용률을 높입니다. '~ 비용', '~ 후기' 형식 제목을 활용하세요.",
        "no_website_guide": "카카오채널로 견적 문의를 받고 네이버 플레이스에 작업 사례 사진을 등록하면 홈페이지 없이도 지역 검색 노출이 가능합니다.",
    },
    "creative": {
        "smartplace_tip": "촬영·작업 포트폴리오 사진을 대표 이미지로 등록하고, 예약 방식과 작업 소요 기간을 소개글에 명시하세요.",
        "blog_tip": "작업 과정과 결과물을 함께 보여주는 포스트가 AI 브리핑 인용에 효과적입니다. '~ 스튜디오 후기' 등 키워드를 제목에 포함하세요.",
        "no_website_guide": "인스타그램 포트폴리오와 네이버 플레이스를 연동하면 홈페이지 없이도 작업물을 효과적으로 노출할 수 있습니다.",
    },
    "leisure": {
        "smartplace_tip": "룸(공간) 종류와 인원 수용 가능 범위, 예약 가능 여부를 소개글에 명시하세요. 단체 이용 가능 여부도 포함하면 좋습니다.",
        "blog_tip": "'~ 데이트 코스', '~ 단체 모임 추천' 등 상황별 키워드를 포함한 포스트가 AI 검색 인용률을 높입니다.",
        "no_website_guide": "네이버 예약과 카카오맵을 연동하면 홈페이지 없이도 실시간 예약 가능 여부를 AI 검색에 노출할 수 있습니다.",
    },
}
...
CHECKLIST_BY_CATEGORY: dict[str, list[dict]] = {
    ...
    "accommodation": [
        {"item": "객실 종류별 사진·기준 인원 전체 등록", "tip": "객실 상세 정보가 예약 조건 검색에서 AI 인용률을 높입니다."},
        {"item": "체크인·체크아웃 시간, 주차 가능 여부 소개글에 명시", "tip": "'주차 가능한 숙소' 등 조건 검색에 노출됩니다."},
        {"item": "네이버 예약 시스템 연동", "tip": "실시간 예약 가능 여부가 AI 브리핑 인용 조건 중 하나입니다."},
    ],
    "pharmacy": [
        {"item": "처방전 조제 가능 여부 소개글에 명시", "tip": "'처방전 조제 가능 약국' 조건 검색에 노출됩니다."},
        {"item": "야간·공휴일 운영 시간 정확히 등록", "tip": "'지금 여는 약국' 실시간 검색에서 AI가 이 정보를 우선 참조합니다."},
        {"item": "건강기능식품 취급 품목 소개글에 명시", "tip": "취급 품목 정보가 AI 검색 인덱스에 포함됩니다."},
    ],
    "kids": [
        {"item": "놀이시설 종류·연령대별 이용 가능 여부 등록", "tip": "'유아 놀이시설' 등 연령 조건 검색에 노출됩니다."},
        {"item": "안전 관리 인증·시설 사진 등록", "tip": "안전 신뢰도 정보가 학부모 대상 AI 추천에 영향을 줍니다."},
        {"item": "보호자 동반 규정·이용 요금 소개글에 명시", "tip": "이용 조건이 명확할수록 AI 브리핑 인용률이 높아집니다."},
    ],
    "service": [
        {"item": "출장 가능 지역·견적 산정 방식 소개글에 명시", "tip": "'출장 견적' 조건 검색에서 우선 노출됩니다."},
        {"item": "작업 전후 사진 10장 이상 등록", "tip": "시공·수리 결과 사진이 AI 신뢰도를 높입니다."},
        {"item": "보증·A/S 정책 소개글에 명시", "tip": "보증 정보가 AI 추천 신뢰도를 높입니다."},
    ],
    "creative": [
        {"item": "포트폴리오 사진·영상 20장 이상 등록", "tip": "작업물 다양성이 AI 검색 노출을 확대합니다."},
        {"item": "예약 방식·작업 소요 기간 소개글에 명시", "tip": "'당일 촬영 가능' 등 조건 검색에 노출됩니다."},
        {"item": "패키지별 가격 정보 명시", "tip": "가격 투명성이 AI 추천 신뢰도를 높입니다."},
    ],
    "leisure": [
        {"item": "룸(공간) 종류·인원 수용 범위 소개글에 명시", "tip": "'단체 모임 가능한 곳' 조건 검색에 노출됩니다."},
        {"item": "예약 시스템(네이버 예약 또는 전화) 연동", "tip": "예약 가능 여부가 AI 브리핑 인용 조건입니다."},
        {"item": "시설·인테리어 사진 10장 이상 등록", "tip": "공간 사진이 방문 전환율과 AI 신뢰도를 높입니다."},
    ],
}
