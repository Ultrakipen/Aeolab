...
FAQ_DATA = [
    ...
    # ── 요금제 (pricing) ─────────────────────────────────────────────────
    {
        ...
        "answer": (
            "Basic(월 9,900원)·창업패키지(12,900원)·Pro(18,900원)·Biz(49,900원)·"
    ...
    },
    {
        ...
        "answer": (
            "Basic 플랜 신규 가입 시 첫 달 50% 할인(4,950원)이 적용됩니다. "
            "이후 월부터는 정상가 9,900원으로 자동 결제됩니다."
        ),
    },
    {
        "category": "pricing",
    ...
    },
    {
        ...
        "answer": (
            "AI 브리핑(플레이스형)은 음식점·카페·숙박 등 일부 업종에만 노출되고, "
            "네이버 AI탭은 2026년 4월부터 모든 업종에서 검색결과에 노출됩니다. "
            "두 채널 모두 스마트플레이스 정보·리뷰·사진·콘텐츠 품질이 핵심입니다."
        ),
    },
    # ── 개선 가이드 (guide) ──────────────────────────────────────────────
    {
