...
*최종 업데이트: 2026-08-23 | 출시 전 "운영 중 대응력" 종합 점검 — 결제-구독 불일치 감지 잡 + 서버 디스크 사용률 알림 잡 신설(git `ab0c2a0`). 상세는 위 항목 참조. CLAUDE.md 700줄 다이어트 겸 2026-08-10·08-21(죽은 admin key) 항목 `docs/changelog_archive.md`로 이관.*
