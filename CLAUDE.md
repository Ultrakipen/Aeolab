...
*최종 업데이트: 2026-08-21 | 미점검 영역 전수조사(git 히스토리+서버drift+PM2라이브로그 직접점검) — 이용약관 §9 손해배상한도가 대행서비스 결제금액 미반영 발견·수정 + Sentry ignoreErrors 노이즈필터 신설(봇 트래픽 급증 대응). PM2 restart_time 472/374건은 크래시아닌 누적수동배포카운터로 반증기각. 잔여: 08-20 토스심사대응 세션의 CLAUDE.md/메모리 미기록분 소급반영 완료, 부하테스트(k6/Locust, 도구 미보유)만 여전히 범위 밖.*
