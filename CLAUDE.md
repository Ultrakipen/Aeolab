...
*최종 업데이트: 2026-08-23 | CSP 데스크톱·admin·모바일 전 영역 실측 검증 완료(위반 0건) + cron 타임존 버그 10건 수정. 상세는 위 항목 참조. CLAUDE.md 700줄 다이어트 겸 08-23 블록 중복 내용 대폭 통합.*
