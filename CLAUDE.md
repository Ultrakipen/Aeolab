...
*최종 업데이트: 2026-08-23 | CSP 신설·강제 적용 + 제3자 보안 스캔(Mozilla Observatory) 실행 완료(git `2507a62`·`03e95a1`). 상세는 위 항목 참조. CLAUDE.md 700줄 다이어트 겸 2026-08-21("Phase 기준 배제 재평가") 항목 `docs/changelog_archive.md`로 이관.*
